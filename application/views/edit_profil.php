                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama" value="<?= $user->nama ?>" class="form-control" placeholder="Masukana Nama Lengkap Karyawan" required="reuqired" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 <?= ($this->session->level == 'Karyawan') ? 'col-sm-6 col-md-4' : 'col-sm-6' ?>">
                            <div class="form-group">
                                ...
                                <input type="tel" name="telp" id="telp" value="<?= $user->telp ?>" class="form-control" placeholder="Masukan No. Telp" required="reuqired" />
                            </div>
                        </div>
                        <div class="col-xs-12 <?= ($this->session->level == 'Karyawan') ? 'col-sm-6 col-md-4' : 'col-sm-6' ?>">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="username" value="<?= $user->username ?>" class="form-control" placeholder="Masukan Username" required="reuqired" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
